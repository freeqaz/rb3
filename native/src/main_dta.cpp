// rb3 (Wii decomp) native — minimal DTA loader.
// Boots the bare minimum of the Milo engine and parses a RB3 songs.dta,
// printing each song's id / name / artist. Proves the RB3-Wii decomp core
// can load RB3 song data under clang LP64 without a renderer or audio device.
