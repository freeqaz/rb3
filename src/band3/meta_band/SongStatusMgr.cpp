...
SongStatusLookup::SongStatusLookup() { Clear(); }
...
SongStatusCacheMgr::SongStatusCacheMgr(const LocalBandUser **user)
    : mUser(user), unk1f54(0) {
...
int SongStatusCacheMgr::SaveSize(int) { REPORT_SIZE("SongStatusCacheMgr", 8000); }
