    ...
    if (!da && !b) {
                ...
                if (*p == '}') {
                    ...
                    *phInfoPos = '\0';
                    ...
                    if (theArr || isToken) {
                        ...
                        switch (phType) {
                        case 0:
                            node_bool = (node.Type() != kDataString)
                        ...
                        case 3:
                            node_bool =
                                (node.Type() != kDataFloat) && (node.Type() != kDataInt);
                            break;
                        case 4:
                            node_bool = false;
                            break;
                            ...
                            case 0:
                                if (node.Type() == kDataString) {
                                    ...
                                    sn_res = snprintf(
                                        ...
                                        baseTempFmt - tempFmtPos,
                                        "%s",
                                        Localize(node.Sym(), false)
                                    );
                                }
                                break;
                            case 1:
                                sn_res = snprintf(
                                    tempFmtPos, baseTempFmt - tempFmtPos, param, node.Int()
                                );
                                break;
                            case 2:
                                sn_res = snprintf(
                    ...
                    tempFmtPos += snprintf(
                        tempFmtPos, baseTempFmt - tempFmtPos, "{missing:%s}", phInfo
                    );
                } else
                    *tempFmtPos++ = *p;
                break;
        ...
        if (i13 != 0) {
            *phInfoPos = '\0';
            ...
            tempFmtPos +=
                snprintf(tempFmtPos, tempFmt - tempFmtPos, "{badfmt:%s", phInfo);
        }
        *tempFmtPos = 0;
