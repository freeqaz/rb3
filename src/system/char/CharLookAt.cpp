...
CharLookAt::CharLookAt()
    : mSource(this), mPivot(this), mDest(this), mHalfTime(0.0f), mMinYaw(-80.0f),
      ...
      mMaxWeightYaw(-1.0f), mWeightYawSpeed(10000.0f), unk6c(1e+29f, 0.0f, 0.0f),
      unk78(1.0f), mSourceRadius(0.0f), vec80(0, 0, 0), mShowRange(0),
#ifdef MILO_DEBUG
      mTestRange(0), mTestRangePitch(0.5f), mTestRangeYaw(0.5f),
#endif
      mAllowRoll(1), unkb1(0), mEnableJitter(0), mYawJitterLimit(0.0f),
