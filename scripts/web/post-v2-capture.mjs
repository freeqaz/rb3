#!/usr/bin/env node
/**
 * RB3 Web — post-V2 screenshot sweep.
 * Navigates splash → main_hub → song_select → part_difficulty → game_screen
 * and saves screenshots to docs/sessions/web/screenshots/post-v2-sweep/
 *
 * Usage:
 *   node scripts/web/post-v2-capture.mjs [--port 8430]
 */
...
const OUT_DIR = resolve(REPO_ROOT, 'docs/sessions/web/screenshots/post-v2-sweep');
