 ...
 *
 * Usage: node scripts/web/w7-hud-capture.mjs [--port 8580]
 */
...
const opts = {
    port: parseInt(argv[argv.indexOf('--port') + 1] || '8580', 10) || 8580,
...
const OUT_DIR = resolve(REPO_ROOT, 'docs/sessions/web/screenshots/w7-hud');
